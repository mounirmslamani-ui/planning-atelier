    ...
    if (existingSteps.length > 0) {
      const initialRows = existingSteps.map((s, i) => {
        ...
        return {
          ...
          materialStatus: computeFieldStatus(s.rawMaterialNotApplicable ?? false, s.rawMaterialItems || []),
          toolingStatus: computeFieldStatus(s.specialToolingNotApplicable ?? false, s.specialToolingItems || []),
