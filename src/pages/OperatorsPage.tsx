...
const OperatorsPage: React.FC = () => {
  const { operators, addOperator, updateOperator, deleteOperator, operations } = usePlanning();
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Fonctions secondaires</TableHead>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium mb-1 block">Fonction principale</label>
              <select 
            ...
            <div>
              <label className="text-sm font-medium mb-1 block">Fonctions secondaires</label>
