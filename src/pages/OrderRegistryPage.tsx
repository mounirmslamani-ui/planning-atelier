              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
                    ...
                    <TableHead className="text-xs"><ColumnHeader label="متابعة تقدّم الطلبية" columnKey="status" sortKey={sortKey} sortDir={sortDir} onSort={handleSort} filterValue={filters.status || ''} onFilter={handleFilter} allValues={allValuesByKey.status} /></TableHead>
